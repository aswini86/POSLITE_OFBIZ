...
public class WebPosEvents {
    ...
    public static String posTerminalId = "BM_POS1";
    ...
    public static WebPosSession getWebPosSession(HttpServletRequest request, String posTerminalId) {
        ...
        if(UtilValidate.isNotEmpty(webPosSession)) {
        	System.out.println("cart------------"+webPosSession.getCart());
        	System.out.println("cart items------------"+cart.getItemTotal());
        	System.out.println("cart total quantity------------"+cart.getTotalQuantity());
        	System.out.println("cart size------------"+cart.size());
        	System.out.println("cart------------------------tax"+cart.getTotalSalesTax());
        	System.out.println("productStoreId------------------------tax"+cart.getProductStoreId());
        }
        if (UtilValidate.isEmpty(webPosSession)) {
    ...
    public static void removeWebPosSession(HttpServletRequest request, String posTerminalId) {
        ...
        System.out.println("webPosSession----------"+session.getAttribute("webPosSession"));
        System.out.println("shoppingCart----------"+session.getAttribute("shoppingCart"));
        session.removeAttribute("shoppingCart");
        session.removeAttribute("webPosSession");
    ...
    public static String completeSale(HttpServletRequest request, HttpServletResponse response) throws GeneralException {
        HttpSession session = request.getSession(true);
        WebPosSession webPosSession = (WebPosSession) session.getAttribute("webPosSession");
        System.out.println("current trns----------"+webPosSession.getCurrentTransaction().getCart());
        if (UtilValidate.isNotEmpty(webPosSession)) {
