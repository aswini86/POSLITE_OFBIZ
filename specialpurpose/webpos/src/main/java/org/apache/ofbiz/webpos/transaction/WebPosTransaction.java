...
public class WebPosTransaction {
    ...
    public BigDecimal processSale() throws GeneralException {
        ...
        System.out.println("grandTotal----"+this.getGrandTotal());
        //BigDecimal grandTotal = this.getSellingPriceGrandTotal();
        BigDecimal grandTotal = this.getPaymentTotal();
    ...
    public BigDecimal getSellingPriceGrandTotal() {
        return getCart().getSellingPriceGrandTotal();
    }
    ...
    public BigDecimal getPosTotalDue() {
        BigDecimal grandTotal = this.getSellingPriceGrandTotal();
        BigDecimal paymentAmt = this.getPaymentTotal();
        return grandTotal.subtract(paymentAmt);
    }
