...
public final class EntityUtil {
    ...
    public static EntityCondition getFilterByDateExpr(java.sql.Timestamp frommoment,java.sql.Timestamp tomoment, String fromDateName, String thruDateName) {
        return EntityDateFilterCondition.makeCondition(frommoment, tomoment, fromDateName, thruDateName);
    }
